            ...
            <div class="page-header pb-10 page-header-dark bg-gradient-primary-to-secondary">
               <div class="container-fluid">
                  <div class="page-header-content d-flex align-items-center justify-content-between text-white">
                     ...
                     <div>
                        <a href="course_edit.php?edit_id=<?php echo $course['course_id']; ?>" title="Edit Organization"
                           class="btn btn-white">
                           <div class="page-header-icon">
                        ...
                        <a href="course_delete.php?delete_id=<?php echo $course['course_id']; ?>"
                           onclick="return confirm('Are you sure you want to delete this course?')"
                           title="Delete Organization" class="btn btn-danger">
                           <div class="page-header-icon">
                  ...
                  <div class="card-body">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="course_name" name="course_name"
                           value="<?php echo strtoupper($course['course_name']); ?>" readonly>
                     </div>
                     <div class="form-group">
                        <label for="course_code">Course Code</label>
                        <input type="text" class="form-control" id="course_code" name="course_code"
                           value="<?php echo strtoupper($course['course_code']); ?>" readonly>
                     </div>
                  </div>
               </div>
            </div>
